...
class FHIRClinicalConnector:
    ...
    def transform_to_omop(self, bundle: Any) -> Any:
...
class OmopTransformer:
    ...
    def _map_patient(self, resource: Any) -> Any:
    ...
    def _map_observation(self, resource: Any) -> Any:
    ...
    def transform(self, bundle: Any) -> Any:

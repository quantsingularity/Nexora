...
class HealthCheck:
    ...
    def _check_http_endpoint(
        ...
        try:
            ...
            return "ERROR", {"message": f"Error checking HTTP endpoint {url}: {str(e)}"}
    ...
    def _check_postgresql(
        ...
        try:
            ...
            return "ERROR", {"message": f"Error checking PostgreSQL database: {str(e)}"}
    ...
    def _check_redis(
        ...
        try:
            ...
            return "FAIL", {"message": f"Failed to connect to Redis database: {str(e)}"}
        except Exception as e:
    ...
    def _check_api_endpoint(
        ...
        try:
            ...
            return "ERROR", {"message": f"Error checking API endpoint {url}: {str(e)}"}
    ...
    def _check_k8s_services(self, core_v1, namespace: str) -> Tuple[str, Dict]:
        ...
        try:
            ...
            return "ERROR", {"message": f"Error checking Kubernetes services: {str(e)}"}

...
class MockHIPAACompliantHealthcareETL:
    ...
    def process_data(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        deidentified_data = self.deidentifier.deidentify_dataframe(
            ...
            phi_cols=['name', 'dob', 'ssn', 'address', 'phone', 'email', 'admission_date', 'discharge_date']
        )
...
class TestFHIRDeidentification(unittest.TestCase):
    ...
    def test_fhir_deidentification(self):
        ...
        original_mrn = self.fhir_bundle['entry'][0]['resource']['identifier'][0]['value']
        ...
        original_start_date = self.fhir_bundle['entry'][1]['resource']['period']['start']
